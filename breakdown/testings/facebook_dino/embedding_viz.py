...
plt.title(f'Feature Map of {name} Network 2 5 ')
plt.show()
plt.savefig(f'Feature Map of {name} Network 2  5')
point_cloud = np.hstack([embedding, colors.reshape(-1, 1)])
wandb.log({f"3D_UMAP222_FeatureMap_{name} 5": wandb.Object3D(point_cloud)})

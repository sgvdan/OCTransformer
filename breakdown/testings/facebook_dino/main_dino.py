...
def get_args_parser():
    ...
    parser.add_argument('--momentum_teacher', default=config.momentum_teacher, type=float, help="""Base EMA
    ...
    parser.add_argument('--warmup_teacher_temp', default=config.warmup_teacher_temp, type=float,
                        help="""Initial value for the teacher temperature: 0.04 works well in most cases.
        Try decreasing it if the training loss does not decrease.""")
    parser.add_argument('--teacher_temp', default=config.teacher_temp, type=float, help="""Final value (after linear warmup)
        of the teacher temperature. For most experiments, anything above 0.07 is unstable. We recommend
        starting with the default value of 0.04 and increase this slightly if needed.""")
    parser.add_argument('--warmup_teacher_temp_epochs', default=config.warmup_teacher_temp_epochs, type=int,
    ...
    parser.add_argument('--weight_decay', type=float, default=config.weight_decay, help="""Initial value of the
        weight decay. With ViT, a smaller value at the beginning of training works well.""")
    parser.add_argument('--weight_decay_end', type=float, default=config.weight_decay_end, help="""Final value of the
    ...
    parser.add_argument('--output_dir', default="./p8", type=str, help='Path to save logs and checkpoints.')

...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_path", default="../../../../data/kermany/val/NORMAL/NORMAL-5193994-1.jpeg", type=str,
                        help="Path of the image to load.")
    #NORMAL/NORMAL-5193994-1                CNV/CNV-8184974-1          DRUSEN/DRUSEN-9894035-2    DME/DME-9583225-1
    parser.add_argument("--image_size", default=(480, 480), type=int, nargs="+", help="Resize image.")
    parser.add_argument('--output_dir', default='./normal_exmpl4', help='Path where to save visualizations.')

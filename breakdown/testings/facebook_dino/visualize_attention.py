...
if __name__ == '__main__':
    ...
    for i in range(4):
        ...
        parser.add_argument("--image_path", default="../../../../data/kermany/val/" + images[i] + ".jpeg",
                            type=str,
        ...
        model.eval()
        model.to(device)
        state_dict = torch.load('mult_gpu_fb_test_med_sugg_wandb_fine_tune/checkpoint0007.pth', map_location="cpu")
        ...
        for path in paths:
            ...
            attentions = \
                nn.functional.interpolate(attentions.unsqueeze(0), scale_factor=args.patch_size, mode="nearest")[
                    0].cpu().numpy()

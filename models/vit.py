...
class MyViT(torch.nn.Module):
    def __init__(self, config):
        ...
        self.model = VisionTransformer(img_size=self.config.input_size, patch_size=(self.config.embedding_dim, 1), in_chans=3, num_classes=4,  # TODO: CHANGE NUM_CLASSES ACCORDING TO DATASET
